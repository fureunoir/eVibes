...
__all__ = [
    ...
    'PostalCode', 'AlternativeName', 'Address'
]

from django.db.models import Manager as GeoManager, PROTECT, Model, UUIDField, BooleanField
...
class BaseCountry(Place, SlugModel):
    ...
    continent = models.ForeignKey(swapper.get_model_name('geo', 'Continent'),
                                  null=True,
...
class Region(Place, SlugModel):
    ...
    country = models.ForeignKey(swapper.get_model_name('geo', 'Country'),
...
class District(Place, SlugModel):
    ...
    location = PointField()
    population = models.IntegerField()
    city = models.ForeignKey(swapper.get_model_name('geo', 'City'),
